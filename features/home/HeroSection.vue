...
<template>
  <section
    class="relative flex min-h-screen flex-col items-center justify-center px-12 py-28 md:py-32"
  >
    <div
      class="mx-auto flex w-full max-w-5xl flex-col items-center gap-14 md:flex-row md:gap-24"
    >
